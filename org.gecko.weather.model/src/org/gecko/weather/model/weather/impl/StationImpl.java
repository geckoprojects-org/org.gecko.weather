...
public class StationImpl extends MinimalEObjectImpl.Container implements Station {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WeatherPackage.STATION__NAME, oldName, name));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLocation(GeoPosition newLocation, NotificationChain msgs) {
		GeoPosition oldLocation = location;
		location = newLocation;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WeatherPackage.STATION__LOCATION, oldLocation, newLocation);
	 ...
	 */
	@Override
	public void setLocation(GeoPosition newLocation) {
		if (newLocation != location) {
			NotificationChain msgs = null;
			if (location != null)
				msgs = ((InternalEObject)location).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WeatherPackage.STATION__LOCATION, null, msgs);
			if (newLocation != null)
				msgs = ((InternalEObject)newLocation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WeatherPackage.STATION__LOCATION, null, msgs);
			msgs = basicSetLocation(newLocation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WeatherPackage.STATION__LOCATION, newLocation, newLocation));
	}
	...
	public void setCountry(String newCountry) {
		...
		country = newCountry;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WeatherPackage.STATION__COUNTRY, oldCountry, country));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WeatherPackage.STATION__LOCATION:
				return getLocation();
			case WeatherPackage.STATION__COUNTRY:
				return getCountry();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case WeatherPackage.STATION__NAME:
				...
				return;
			case WeatherPackage.STATION__LOCATION:
				setLocation((GeoPosition)newValue);
				return;
			case WeatherPackage.STATION__COUNTRY:
